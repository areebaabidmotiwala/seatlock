...
Setup
Create a database (e.g. seatlock) in PostgreSQL.
...
Edit DB_CONFIG in both scripts/concurrency_simulation.py and scripts/seatlock_cli.py to match your local PostgreSQL setup.
Try it:
bash
